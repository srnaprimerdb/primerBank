...
# 	1. srnaprimer_miRNA_results.db is a databases file contains piRNA primers results.
# 	2. srnaprimer_query.py is a program for querying the priemr results from srnaprimer_results.db.
